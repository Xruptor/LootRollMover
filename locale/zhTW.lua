...
L.SlashAnchorOn = "錨點 [|cFF99CC33顯示|r]"
L.SlashAnchorOff = "錨點 [|cFF99CC33隱藏|r]"
...
L.Alert_Anchor = "警報錨點"
L.Bonus_Anchor = "額外擲骰錨點"

L.SlashReset = "重置"
L.SlashResetText = "重置錨點位置"
L.SlashResetInfo = "重置錨點位置。"
L.SlashResetAlert = "錨點位置已重置！"

L.SlashScale = "比例"
L.SlashScaleSet = "比例設置為 [|cFF20ff20%s|r]"
L.SlashScaleSetInvalid = "數值無效！數字必須介於 [0.5 - 5]。(0.5, 1, 3, 4.6, 等..)"
